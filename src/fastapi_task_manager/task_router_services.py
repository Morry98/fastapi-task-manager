            ...
            list_to_return.append(
                TaskDetailed(
                    ...
                    is_active=not redis_client.exists(
                        task_manager.config.redis_key_prefix + "_" + tg.name + "_" + t.name + "_disabled",
                    ),
                    runs=[
                        TaskRun(
...
def disable_task(
    ...
    redis_client.set(
        task_manager.config.redis_key_prefix + "_" + task_group.name + "_" + task.name + "_disabled",
        "1",
